$path = "c:\Users\DELL\Downloads\HSMV\member-login.html"
$content = [System.IO.File]::ReadAllText($path)

$cssStart = $content.IndexOf("/* --- INJECTED CARD STYLES --- */")
$cssEnd = $content.IndexOf("/* --- PRINT STRATEGY --- */")
...
$html1Start = $content.IndexOf('<div class="id-card-wrapper" style="display:none;">')
$html1End = $content.IndexOf('<div class="offer-letter-page" style="display:none;">')

$newHtml1 = @"
<div class="id-card-wrapper" style="display:none;">
    <!-- ================= FRONT SIDE ================= -->
    <div class="id-card">
...
$content = $content.Substring(0, $html1Start) + $newHtml1 + $content.Substring($html1End)

$html2Start = $content.IndexOf('<div class="offer-letter-page" style="display:none;">')
$html2End = $content.IndexOf('<div class="login-wrap" id="loginWrap">')

$newHtml2 = @"
<div class="offer-letter-page" style="display:none;">
...
$content = $content.Substring(0, $html2Start) + $newHtml2 + $content.Substring($html2End)
